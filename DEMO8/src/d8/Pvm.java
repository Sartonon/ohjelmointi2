...
public class Pvm {
    ...
    public void paivays() {
        ...
        pv = Integer.parseInt(paiva.format(cal.getTime()));
        kk = Integer.parseInt(kuukausi.format(cal.getTime()));
        vv = Integer.parseInt(vuosi.format(cal.getTime()));
    }
    ...
    public static void main(String[] args) {
        ...
        Pvm tammi2013 = new Pvm(1,1); // =>  1.1.2013
        Pvm maalis2013 = new Pvm(1);  // =>  1.3.2013 
        Pvm tanaan = new Pvm();       // =>  5.3.2011
        System.out.println(tammi2005);
        System.out.println(tammi2013);
        System.out.println(maalis2013);
