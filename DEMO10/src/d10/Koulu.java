...
public class Koulu {
  ...
  public void lisaa(Oppilas oppilas) {
      if ( ensimmainen != null ) viimeinen.seuraava = oppilas;
      else ensimmainen = oppilas;
      viimeinen = oppilas;
      oppilaita++;
  }
  ...
  public void poistaKaikki() {
      Oppilas oppilas = ensimmainen;
      while (oppilas != null) {
          ensimmainen = null;
          oppilas = oppilas.seuraava;
      }
      oppilaita = 0;
  }
  ...
  public static void main(String[] args)  {
    ...
    luokka.tulosta(System.out); // plapla
    luokka.poistaKaikki();
